    ...
    <footer className="site-footer">
      <div className="footer-grid">
        <div className="footer-brand">
          <img src="/STARPACE_white.png" alt="Star Pace Logo" style={{ height: 48, objectFit: 'contain', marginBottom: 16 }} />
          <p>
          ...
          <div style={{ display: 'grid', gap: 16 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
                <a href="tel:+233000000000" style={{ fontSize: 13, fontWeight: 700, color: '#fff', textDecoration: 'none' }}>+233 000 000 000</a>
                <a href="tel:+233000000000" style={{ fontSize: 13, fontWeight: 700, color: '#fff', textDecoration: 'none' }}>+233 000 000 000</a>
              </div>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
